...
//    [MobClick updateOnlineConfig];
    ...
    NSString * appKey = [HLInterface sharedInstance].umeng_code;
...
//    }
//    return false;
    return [HLAnalyst boolValue:key];
}
...
//    return defaultV;
    ...
    return [HLAnalyst intValue:key defaultValue:defaultV];
...
//    NSString *value = [MobClick getConfigParams:key];
//    return value;
    return [HLAnalyst stringValue:key];
}
